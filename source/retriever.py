...
class RetrieverTool(Tool):
    ...
    def forward(
        ...
        #    raise ValueError (f"Wrong for question: {question}, Retrieved queries are too diffrent to recent question/query (Retrieved questions/queries  : {doc_min}) rewrite the question/query.")
